...
# Target log path
logs_path = 'data/tensorflow/rnn_words'
writer = tf.summary.FileWriter(logs_path)

# Text file containing words for training
training_file = 'data/harry_porter.txt'
...
with tf.Session() as session:
    ...
    while step < training_iters:
        ...
        _, acc, loss, onehot_pred, sum_merge = session.run([optimizer, accuracy, cost_function, pred, merged_summ], \
                                                feed_dict={x: symbols_in_keys, y: symbols_out_onehot})

        writer.add_summary(sum_merge)
